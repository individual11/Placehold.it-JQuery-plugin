...
(function( $ ){
  $.fn.placeholdit = function( options ) {
    ...
    var settings = {
    	...
    	'type'				:	'default'	//->'default' uses Placehold.it to generate images, 'kitten' uses placekitten.com (if you pass '000' or '000000' as the background color, the images will be b&w)
    }
